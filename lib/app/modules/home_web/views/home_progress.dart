...
class HomeProgress extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<Trx>>(
      stream: homeC.getDatatrxSse(cabang, date, "0"),
      // stream: homeC.dummyStream(),
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return DataTable2(
            ...
            fixedLeftColumns: 1,
            columns: const [
              DataColumn2(label: Text('No Transaksi'), size: ColumnSize.L),
              DataColumn2(label: Text('No Kendaraan'), fixedWidth: 110),
            ...
            Row(
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: SizedBox(
                    height: 18,
                    child: Text(nopol, style: const TextStyle(fontSize: 17)),
                  ),
                ),
              ],
            ),
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Expanded(
                  ...
                  child: SizedBox(
                    height: 18,
                    child: Text(masuk, style: const TextStyle(fontSize: 17)),
                  ),
                ),
              ],
            ),
                                  ...
                                  return TextField(
                                    ...
                                    onSubmitted: (String value) {
                                      for (
                                        ...
                                        if (dataKendaraan[i].serviceName ==
                                            value) {
                                          homeC.listService.add(
                                            dataKendaraan[i].serviceName,
                                          );
                                          homeC.serviceItem.add(
                                            dataKendaraan[i].id,
                                          );
                                        }
                                      }
                          ...
                          Row(
                            children: [
                              ...
                              Column(
                                children: [
                                  for (var i
                                      in homeC.selectedService.toSet().toList())
                                    Text(
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      showDefaultDialog2("Sukses", "Data berhasil diperbarui");
