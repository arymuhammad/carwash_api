...
class LaporanView extends GetView<LaporanController> {
  LaporanView(this.cabang, {super.key});
                          ...
                          child: DataTable2(
                              ...
                              rows: List<DataRow>.generate(2, (index) {
                                return DataRow(cells: [
                                  DataCell(Text(index == 0 ? 'Motor' : 'Mobil',
                                      style: const TextStyle(
                                        fontSize: 15,
                                      ))),
                                  DataCell(Obx(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                      NumberFormat.simpleCurrency(
                                                                              ...
                                                                              decimalDigits:
                                                                                  0)
                                                                          .format(int.parse(srvc[index].harga!) *
                                                                              lapC
                                                                                  .qty),
                                                                      style:
                                                                          const TextStyle(
            ...
            SpeedDialChild(
              ...
              onTap: () async {
                ...
                await lapC.getSummary(lapC.date1.value = dateNow1.toString(),
                    lapC.date2.value = dateNow2.toString(), 0);
                Future.delayed(const Duration(seconds: 1), () {
                  Get.back();
                });
              },
              ...
              child: ElevatedButton(
                  onPressed: () async {
                    ...
                    if (dateInputAwal.text == "" && dateInputAkhir.text == "") {
                      ...
                      await lapC.getSummary(
                          dateInputAwal.text, dateInputAkhir.text, 0);
                      Future.delayed(const Duration(seconds: 1), () {
                        Get.back();
                        Get.back();
                      });
