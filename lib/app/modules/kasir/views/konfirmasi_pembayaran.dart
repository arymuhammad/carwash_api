...
bayar(
    username, userId, kodeCabang, namaCabang, noTrx, tanggal, serviceItem, alamat, telp, kota) {
  Get.defaultDialog(
    radius: 5,
            ...
            children: [
              ...
              ElevatedButton(
                  onPressed: () {
                    ...
                    checkOut(username, userId, noTrx, kodeCabang, namaCabang, tanggal,
                        serviceItem, service, price, alamat, telp, kota);
                  },
                  child: const Text(
                    'Checkout',
